...
2. Provide appropriate connectivity and network services for the assigned 
   scenario.
3. Accommodate the stated design constraint and change request.
4. Produce a working, testable Packet Tracer implementation.
...
- Capture clear evidence of successful operation/configuration.
