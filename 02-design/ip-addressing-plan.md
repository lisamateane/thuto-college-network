...
**10.18.0.0/16** (as specified in the client brief)
...
the addressing scheme simple, uniform and easy to explain and verify,which is
...
The router (HQ-Router) holds the gateway IP for every VLAN, enabling inter-VLAN routing 
